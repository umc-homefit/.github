...
| 이름 | 담당 |
|---|---|
| **찬찬 / 김찬혁** | Backend Team Lead · Notice · DB · Infra · UMC 10th 베스트 챌린저 |
...
| 이름 | 담당 |
|---|---|
| **리비 / 홍지원** | Android Team Lead · 앱 아키텍처·공통 컴포넌트 · 입주 분석·API 통합 |
| **릴리 / 김혜민** | 공고 목록·필터·상세·경쟁률 · 로그인 |
| **제이 / 박유진** | 홈·알림 · 금융상품 목록·추천·검색·상세 |
| **양고 / 전서영** | 마이페이지 · 저장 공고 · 알림 설정 · 금융정보 관리 · 회원가입·소셜 로그인 |

### Product & Design

| 이름 | 담당 |
|---|---|
| **토리 / 장지안** | Product Manager · 기획 · MVP 범위·사용자 시나리오 조율 |
| **양파 / 이승언** | Product Designer · UX/UI · 디자인 시스템·화면 설계 |
...
HomeFit의 UMC 10th 개발과 데모 운영은 2026년 8월 22일에 종료되었습니다. 데모용 AWS 과금 리소스는 운영 종료 후 회수했으며, 원본 코드와 문서는 위 저장소에서 확인할 수 있습니다.
